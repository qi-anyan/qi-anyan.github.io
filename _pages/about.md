...
As an active member of the academic community, Anyan serves as an Associate Editor for **Manufacturing & Service Operations Management**, a Senior Editor for **Production and Operations Management**, an Associate Editor for **Decision Sciences**, a Department Editor for the **Journal of Systems Science and Systems Engineering**, and a Guest Associate Editor for **Management Science**. He has received the Management Science Distinguished Service Award, the Management Science Meritorious Service Award, and the M&SOM Meritorious Service Award. In JSOM, he also serves as the PhD Area Coordinator for Operations Management ([Program LinkedIn Page](https://www.linkedin.com/company/jsom-operations-management-phd-program/?viewAsMember=true)). 
